...
public class ExplosiveArrowEntity extends Arrow {
    ...
    // 用于发射的构造函数
    public ExplosiveArrowEntity(Level world, LivingEntity owner, ItemStack stack, @Nullable ItemStack shotFrom) {
    ...
    protected void doPostHurtEffects(LivingEntity target) {
        ...
        if (!this.level().isClientSide()) {
            ...
            this.level().explode(this, this.getX(), this.getY(), this.getZ(), 3.3F,
